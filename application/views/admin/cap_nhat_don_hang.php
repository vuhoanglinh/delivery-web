        ...
        <section id="content">
          <section class="vbox">
            <section class="scrollable padder">
              ...
              <div class="row">                
                <div class="col-sm-6">
                  <form data-validate="parsley" method="post" action="<?php echo site_url('admin/submit_cap_nhat_don_hang/'.$don_hang['id']); ?>">
					<input type="hidden" name="ma_don_hang" value="<?php echo $don_hang['id']; ?>" >
                    <section class="panel panel-default">                     
                      <div class="panel-body">  						 
						  <div class="form-group">
                            <label>Nhân viên phụ trách <span class="field-req">*</span></label>
                            <select name="ma_nhan_vien" class="form-control">                
								...
								?>
									<option value="<?php echo $nhan_vien['id']; ?>" <?php if($nhan_vien['id'] == $don_hang['id_giao_nhan']){ echo 'selected="selected"'; }?>><?php echo $nhan_vien['ten']; ?></option>			
								<?php 
									}
								?>								
							</select>
