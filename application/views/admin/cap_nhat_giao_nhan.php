        ...
        <section id="content">
          <section class="vbox">
            <section class="scrollable padder">
              <div class="m-b-md">
                <h3 class="m-b-none">Cập nhật thông tin giao nhận</h3>
              </div>
              ...
              <div class="row">                
                <div class="col-sm-6">
                  <form data-validate="parsley" method="post" action="<?php echo site_url('admin/cap_nhat_giao_nhan'); ?>">
                      ...
                      <div class="panel-body">  
						  ...
						  <div class="form-group pull-in clearfix">
                            <div class="col-sm-6">
                              ...
                              <input type="password" name="mat_khau" class="form-control" placeholder="Password" data-required="true">
                            </div>
                            <div class="col-sm-6">
                              <label>Re-Password</label>
                              <input type="password"  name="re_mat_khau" class="form-control" placeholder="Re-Password" data-required="true" >
                            </div>
                          </div>						  
						  <div class="form-group pull-in clearfix">
                            <div class="col-sm-6">
