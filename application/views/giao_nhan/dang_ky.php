...
<body class="">
  <section id="content" class="m-t-lg wrapper-md animated fadeInDown">
    <div class="container aside-xl">	  
      ...
      <a class="navbar-brand block" href="javascript:void(0)">Đăng ký Giao Nhận</a>
      <section class="m-b-lg">       
        <form method="post" action="<?php echo site_url('giao_nhan/submit_reg'); ?>">
          <div class="list-group">
            <div class="list-group-item">
              <input name="ten" placeholder="Tên" class="form-control no-border">
            </div>
            <div class="list-group-item">
			...
			<div class="list-group-item">
               <input name="re_mat_khau" type="password" placeholder="Nhập lại mật khẩu" class="form-control no-border">
            </div>
			 <div class="list-group-item">
              <input name="dia_chi" placeholder="Địa chỉ" class="form-control no-border">
            </div>
			 <div class="list-group-item">
              <input name="dien_thoai" placeholder="Điện thoại" class="form-control no-border">
            </div>
          </div>
          ...
          <a href="<?php echo base_url('giao_nhan/login'); ?>" class="btn btn-lg btn-default btn-block">Đăng nhập</a>
        </form>
      </section>
    </div>
  </section>
