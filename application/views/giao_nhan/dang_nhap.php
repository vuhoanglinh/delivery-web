...
<head>  
  <meta charset="utf-8" />
  <title>Đăng nhập giao nhận</title>
...
<body class="">
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    ...
    <div class="container aside-xl">
      <a class="navbar-brand block" href="javascript:void(0)">Đăng nhập giao nhận</a>
      <section class="m-b-lg">      
        <form method="post" action="<?php echo base_url('giao_nhan/submit_log'); ?>">
