...
<head>  
  <meta charset="utf-8" />
  <title>Gủi lại mã xác nhận</title>
...
<body class="">
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    ...
    <div class="container aside-xl">
      <a class="navbar-brand block" href="javascript:void(0)">Gửi lại mã xác nhận</a>
      <section class="m-b-lg">      
        <form method="post" action="<?php echo base_url('khach_hang/submit_resend_active'); ?>">
          <div class="list-group">
            <div class="list-group-item">
              <input name="email" type="email" data-required="true" placeholder="Email" class="form-control no-border">
            </div>            
          </div>
          <button type="submit" class="btn btn-lg btn-primary btn-block">Gửi yêu cầu</button>          
